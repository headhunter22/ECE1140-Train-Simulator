...
" }")
        ...
        self.ACprogressBar.setGeometry(QRect(10, 300, 161, 21))
...
"padding: 2px;")
        ...
        self.sigFaultLabel.setGeometry(QRect(10, 390, 71, 61))
        ...
        self.EmerButton.setGeometry(QRect(540, 250, 241, 151))
...
"padding: 2px;")
        ...
        self.ACIcon.setGeometry(QRect(190, 290, 51, 51))
        ...
        self.brakeFaultLabel.setGeometry(QRect(150, 390, 71, 61))
        ...
        self.powFaultLabel.setGeometry(QRect(80, 390, 71, 61))
...
"padding: 2px;")
        ...
        self.destLabel.setGeometry(QRect(540, 90, 231, 71))
...
"padding: 2px;")
        ...
        self.tempSlider.setGeometry(QRect(10, 330, 160, 18))
        self.tempSlider.setOrientation(Qt.Horizontal)
        self.beaconLabel = QLabel(self.centralwidget)
        self.beaconLabel.setObjectName(u"beaconLabel")
        self.beaconLabel.setGeometry(QRect(540, 170, 231, 61))
        self.beaconLabel.setStyleSheet(u"border: 2px solid black;\n"
"border-radius: 4px;\n"
"padding: 2px;")
