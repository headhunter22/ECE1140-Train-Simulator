...
class WMainWindowA(QtWidgets.QMainWindow, Ui_MainWindowA):
    def __init__(self, *args, obj=None, **kwargs):
        ...
        self.pushn.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'N'))
        self.pusho.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'O'))
        self.pushp.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'P'))
        self.pushq.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'Q'))
        self.pushr.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'R'))
        self.pushs.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'S'))
        self.pusht.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'T'))
        self.pushu.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'U'))
        self.pushv.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'V'))
        self.pushw.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'W'))
        self.pushx.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'X'))
        self.pushy.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'Y'))
        self.pushz.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'Z'))
...
class WMainWindowB(QtWidgets.QMainWindow, Ui_MainWindowB):
    def __init__(self, *args, obj=None, **kwargs):
        ...
        #pop up windows
        self.trackconfiguration.clicked.connect(WaysideUIFunctions.configurationWindow)
        self.pusha.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'A'))
        self.pushb.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'B'))
        self.pushc.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'C'))
        self.pushd.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'D'))
        self.pushe.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'E'))
        self.pushf.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'F'))
        self.pushg.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'G'))
        self.pushh.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'H'))
        self.pushi.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'I'))
        self.pushj.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'J'))
        self.pushk.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'K'))
        self.pushm.clicked.connect(lambda i: WaysideUIFunctions.makeSectionWindow(i, 'M'))
