...
class reparsedTrack(QtWidgets.QMainWindow):
    def __init__(self, track, *args, **kwargs):
        ...
        for block in self.track.getLine(self.track.lines[0].lineName).blocks:
            ...
            beaconLabel = QtWidgets.QLabel(str(block.beaconBool), self)
            beaconLabel.setFixedHeight(50)
            beaconLabel.setFixedWidth(125)
            beaconLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
            self.hbox.addWidget(beaconLabel)
