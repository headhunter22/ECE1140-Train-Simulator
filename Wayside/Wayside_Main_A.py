...
class Ui_MainWindowA(object):
    def setupUi(self, MainWindowA):
        ...
        MainWindowA.resize(733, 681)
        self.centralwidget = QtWidgets.QWidget(parent=MainWindowA)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(parent=self.centralwidget)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 0, 621, 621))
...
"color: rgb(0, 0, 0);")
        ...
        self.pushzz = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        self.pushzz.setObjectName("pushzz")
        self.gridLayout_4.addWidget(self.pushzz, 15, 0, 1, 1)
        self.zzicon = QtWidgets.QLabel(parent=self.verticalLayoutWidget_2)
        self.zzicon.setMaximumSize(QtCore.QSize(50, 50))
        self.zzicon.setText("")
        self.zzicon.setPixmap(QtGui.QPixmap("tracks.png"))
        self.zzicon.setScaledContents(True)
        self.zzicon.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.zzicon.setObjectName("zzicon")
        self.gridLayout_4.addWidget(self.zzicon, 15, 1, 1, 1)
        self.verticalLayout_5.addLayout(self.gridLayout_4)
        self.horizontalLayout_6.addLayout(self.verticalLayout_5)
        self.line_7 = QtWidgets.QFrame(parent=self.verticalLayoutWidget_2)
        self.line_7.setMaximumSize(QtCore.QSize(16777215, 582))
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindowA):
        ...
        self.pushzz.setText(_translate("MainWindowA", "Z"))
