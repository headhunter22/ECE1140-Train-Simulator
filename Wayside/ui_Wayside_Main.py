...
from PySide6.QtWidgets import (QApplication, QDateTimeEdit, QHeaderView, QLCDNumber,
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dateTimeEdit.setGeometry(QRect(10, 0, 194, 29))
        self.pushButton = QPushButton(self.centralwidget)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(402, 480, 231, 29))
        self.pushButton_2 = QPushButton(self.centralwidget)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(400, 510, 231, 29))
        ...
        self.tableWidget.setItem(11, 0, __qtablewidgetitem25)
        self.tableWidget.setObjectName(u"tableWidget")
        self.tableWidget.setGeometry(QRect(10, 30, 271, 471))
        self.lcdNumber = QLCDNumber(self.centralwidget)
        self.lcdNumber.setObjectName(u"lcdNumber")
        self.lcdNumber.setGeometry(QRect(210, 0, 64, 23))
        self.verticalScrollBar = QScrollBar(self.centralwidget)
        self.verticalScrollBar.setObjectName(u"verticalScrollBar")
        self.verticalScrollBar.setGeometry(QRect(280, 30, 16, 471))
        ...
        self.tableWidget_2.setItem(3, 0, __qtablewidgetitem35)
        self.tableWidget_2.setObjectName(u"tableWidget_2")
        self.tableWidget_2.setGeometry(QRect(300, 110, 271, 181))
        self.tableWidget_3 = QTableWidget(self.centralwidget)
        if (self.tableWidget_3.columnCount() < 3):
            self.tableWidget_3.setColumnCount(3)
        __qtablewidgetitem36 = QTableWidgetItem()
        self.tableWidget_3.setHorizontalHeaderItem(0, __qtablewidgetitem36)
        __qtablewidgetitem37 = QTableWidgetItem()
        self.tableWidget_3.setHorizontalHeaderItem(1, __qtablewidgetitem37)
        __qtablewidgetitem38 = QTableWidgetItem()
        self.tableWidget_3.setHorizontalHeaderItem(2, __qtablewidgetitem38)
        if (self.tableWidget_3.rowCount() < 2):
            self.tableWidget_3.setRowCount(2)
        __qtablewidgetitem39 = QTableWidgetItem()
        self.tableWidget_3.setVerticalHeaderItem(0, __qtablewidgetitem39)
        __qtablewidgetitem40 = QTableWidgetItem()
        self.tableWidget_3.setVerticalHeaderItem(1, __qtablewidgetitem40)
        __qtablewidgetitem41 = QTableWidgetItem()
        self.tableWidget_3.setItem(0, 0, __qtablewidgetitem41)
        __qtablewidgetitem42 = QTableWidgetItem()
        self.tableWidget_3.setItem(1, 0, __qtablewidgetitem42)
        self.tableWidget_3.setObjectName(u"tableWidget_3")
        self.tableWidget_3.setGeometry(QRect(300, 290, 391, 111))
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 703, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem13.setText(QCoreApplication.translate("MainWindow", u"L", None));
        self.tableWidget.setSortingEnabled(__sortingEnabled)

        ___qtablewidgetitem14 = self.tableWidget_2.horizontalHeaderItem(0)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("MainWindow", u"Switch", None));
        ___qtablewidgetitem15 = self.tableWidget_2.horizontalHeaderItem(1)
        ___qtablewidgetitem15.setText(QCoreApplication.translate("MainWindow", u"Direction", None));

        __sortingEnabled1 = self.tableWidget_2.isSortingEnabled()
        self.tableWidget_2.setSortingEnabled(False)
        ___qtablewidgetitem16 = self.tableWidget_2.item(0, 0)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("MainWindow", u"C", None));
        ___qtablewidgetitem17 = self.tableWidget_2.item(1, 0)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("MainWindow", u"G", None));
        ___qtablewidgetitem18 = self.tableWidget_2.item(2, 0)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("MainWindow", u"J", None));
        ___qtablewidgetitem19 = self.tableWidget_2.item(3, 0)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow", u"J", None));
        self.tableWidget_2.setSortingEnabled(__sortingEnabled1)

        ___qtablewidgetitem20 = self.tableWidget_3.horizontalHeaderItem(0)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("MainWindow", u"Gates", None));
        ...
        ___qtablewidgetitem22.setText(QCoreApplication.translate("MainWindow", u"Lights", None));

        __sortingEnabled2 = self.tableWidget_3.isSortingEnabled()
        self.tableWidget_3.setSortingEnabled(False)
        ___qtablewidgetitem23 = self.tableWidget_3.item(0, 0)
