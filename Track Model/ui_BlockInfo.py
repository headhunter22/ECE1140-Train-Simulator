...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollArea.setGeometry(QRect(0, 100, 991, 381))
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(0, 0, 951, 61))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QRect(0, 60, 951, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Section A Info", None))
