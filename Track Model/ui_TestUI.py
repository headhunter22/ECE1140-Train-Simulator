...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.OccSecSel = QComboBox(self.centralwidget)
        self.OccSecSel.addItem("")
        self.OccSecSel.addItem("")
        self.OccSecSel.addItem("")
        self.OccSecSel.setObjectName(u"OccSecSel")
        self.OccSecSel.setGeometry(QRect(90, 320, 91, 32))
        self.OccBlockSel = QComboBox(self.centralwidget)
        self.OccBlockSel.addItem("")
        self.OccBlockSel.addItem("")
        self.OccBlockSel.addItem("")
        self.OccBlockSel.setObjectName(u"OccBlockSel")
        self.OccBlockSel.setGeometry(QRect(180, 320, 71, 32))
        self.Connection = QLabel(self.centralwidget)
        self.Connection.setObjectName(u"Connection")
        self.Connection.setGeometry(QRect(270, 90, 121, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.OccSecSel.setItemText(0, QCoreApplication.translate("MainWindow", u"A", None))
        self.OccSecSel.setItemText(1, QCoreApplication.translate("MainWindow", u"B", None))
        self.OccSecSel.setItemText(2, QCoreApplication.translate("MainWindow", u"C", None))

        self.OccBlockSel.setItemText(0, QCoreApplication.translate("MainWindow", u"A", None))
        self.OccBlockSel.setItemText(1, QCoreApplication.translate("MainWindow", u"B", None))
        self.OccBlockSel.setItemText(2, QCoreApplication.translate("MainWindow", u"C", None))
